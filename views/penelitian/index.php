...
if ($search) {
    $where_conditions[] = "(judul ILIKE $" . $param_count . " OR deskripsi ILIKE $" . $param_count . " OR abstrak ILIKE $" . $param_count . ")";
    $params[] = "%$search%";
    $param_count++;
}
...
// Get total
$count_query = "SELECT COUNT(*) as total FROM hasil_penelitian $where_clause";
    ...
    <div class="container">
                ...
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="kategori" class="form-select">
                            ...
                            <option value="Fundamental" <?php echo $kategori == 'Fundamental' ? 'selected' : ''; ?>>Fundamental</option>
                            <option value="Terapan" <?php echo $kategori == 'Terapan' ? 'selected' : ''; ?>>Terapan</option>
                            <option value="Pengembangan" <?php echo $kategori == 'Pengembangan' ? 'selected' : ''; ?>>Pengembangan</option>
                        </select>
                    </div>
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?php echo BASE_URL; ?>/uploads/penelitian/<?php echo htmlspecialchars($item['file_pdf']); ?>" 
        ...
        <div class="text-center py-5">
            ...
            <h4 class="mt-3 text-muted">
                <?php echo ($search || $tahun || $kategori) ? 'Tidak Ada Hasil' : 'Belum Ada Penelitian'; ?>
            </h4>
            <p class="text-muted">
                <?php echo ($search || $tahun || $kategori) ? 'Coba ubah filter pencarian Anda' : 'Hasil penelitian akan ditampilkan di sini'; ?>
            </p>
        </div>
