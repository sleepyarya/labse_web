...
// Hitung jumlah artikel member
$query_count = "SELECT COUNT(*) as total FROM artikel WHERE personil_id = $1";
$result_count = pg_query_params($conn, $query_count, array($member_id));
$total_articles = pg_fetch_assoc($result_count)['total'];

// Get recent articles
$query_recent = "SELECT id, judul, created_at FROM artikel 
                 WHERE personil_id = $1 
                 ORDER BY created_at DESC LIMIT 5";
$result_recent = pg_query_params($conn, $query_recent, array($member_id));
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center p-4">
                    ...
                    <a href="add_article.php" class="btn btn-sm btn-success">
        ...
        <div class="col-12" data-aos="fade-up" data-aos-delay="400">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-0">
                    <?php if (pg_num_rows($result_recent) > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php while ($article = pg_fetch_assoc($result_recent)): ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a href="view_article.php?id=<?php echo $article['id']; ?>" 
                                                   class="btn btn-outline-info" title="Lihat Artikel" data-bs-toggle="tooltip">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="edit_article.php?id=<?php echo $article['id']; ?>" 
                                                   class="btn btn-outline-primary" title="Edit Artikel" data-bs-toggle="tooltip">
                    ...
                    <?php else: ?>
                        <div class="text-center py-5 text-muted">
                            ...
                            <a href="add_article.php" class="btn btn-primary mt-3">
                                <i class="bi bi-plus-circle me-2"></i>Buat Artikel Pertama
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
                <?php if (pg_num_rows($result_recent) >= 5): ?>
...
<style>
    ...
    /* Fix welcome card glitch */
    .card[style*="background: linear-gradient"] {
        background: linear-gradient(135deg, #4A90E2 0%, #68BBE3 100%) !important;
        position: relative;
        overflow: hidden;
    }
