<?php
// Admin Kelola Kategori Artikel
require_once 'auth_check.php';
require_once __DIR__ . '/../includes/config.php';

$page_title = 'Kelola Kategori Artikel';
    ...
    if (isset($_POST['action'])) {
        ...
        if ($action === 'add') {
            ...
            if (empty($nama_kategori)) {
                ...
                // Check for duplicate
                $check_query = "SELECT COUNT(*) as total FROM kategori_artikel WHERE nama_kategori = $1";
                ...
                if ($check_data['total'] > 0) {
                    ...
                    $query = "INSERT INTO kategori_artikel (nama_kategori, slug, deskripsi, warna, is_active) VALUES ($1, $2, $3, $4, TRUE)";
        ...
        elseif ($action === 'edit') {
            ...
            if (empty($nama_kategori)) {
                ...
                $check_query = "SELECT COUNT(*) as total FROM kategori_artikel WHERE nama_kategori = $1 AND id != $2";
                ...
                if ($check_data['total'] > 0) {
                    ...
                    $query = "UPDATE kategori_artikel SET nama_kategori = $1, slug = $2, deskripsi = $3, warna = $4, is_active = $5, updated_at = NOW() WHERE id = $6";
        ...
        elseif ($action === 'delete') {
            ...
            $check_query = "SELECT COUNT(*) as total FROM artikel WHERE kategori_id = $1";
            $check_result = pg_query_params($conn, $check_query, array($id));
            $check_data = pg_fetch_assoc($check_result);
            
            if ($check_data['total'] > 0) {
                $error_msg = 'Tidak dapat menghapus kategori karena masih ada ' . $check_data['total'] . ' artikel menggunakan kategori ini!';
            } else {
                $query = "DELETE FROM kategori_artikel WHERE id = $1";
        ...
        elseif ($action === 'toggle') {
            ...
            $query = "UPDATE kategori_artikel SET is_active = NOT is_active, updated_at = NOW() WHERE id = $1";
            $result = pg_query_params($conn, $query, array($id));
...
// Get all kategori
$query = "SELECT k.*, 
          (SELECT COUNT(*) FROM artikel WHERE kategori_id = k.id) as total_artikel
...
<div class="admin-content">
    ...
    <div class="admin-topbar">
        <div>
            <h4 class="mb-0">Kelola Kategori Artikel</h4>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="bi bi-tags me-2"></i>Daftar Kategori Artikel
                    </h5>
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-info"><?php echo $row['total_artikel']; ?> artikel</span>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-danger" 
                                                onclick="confirmDelete(<?php echo $row['id']; ?>, '<?php echo htmlspecialchars($row['nama_kategori']); ?>', <?php echo $row['total_artikel']; ?>)"
                                                title="Hapus">
                ...
                <div class="text-center py-5 text-muted">
                    ...
                    <p class="mt-3 mb-0">Belum ada kategori artikel</p>
            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="add_nama_kategori" name="nama_kategori" required placeholder="Contoh: Tutorial">
                    </div>
            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <p class="text-muted small mb-0">
                        ...
                        Kategori hanya dapat dihapus jika tidak ada artikel yang menggunakannya.
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
...
function confirmDelete(id, nama, totalArtikel) {
    if (totalArtikel > 0) {
        alert('Tidak dapat menghapus kategori ini karena masih ada ' + totalArtikel + ' artikel menggunakannya!');
        return;
    }
